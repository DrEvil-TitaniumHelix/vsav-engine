...
- post 9.2 strength points of garrison per 10 VP of occupation-hex value
- draw garrisons from up to 24 hexes away
- weight already-credited hexes at 1.50x when assigning garrisons (1.0 = defend what you hold as hard as what you want)
- weight enemy-scoring hexes at 1.80x for denial garrisons
- the field force advances only above 2 combined strength - below that it stands
- objective choice scores VP value at weight 3.00
- and distance at weight 0.71 (0 = ignore distance, pick the richest prize)
- from turn 11, units spread to grab the nearest uncredited VP hexes one-by-one
- from turn 8, units standing on exit hexes leave the map to bank exit VP
- reinforcements join the field force with propensity 0.97 (vs garrison duty)
- artillery yes (1 = classic 2-3 hex standoff, 0 = fights in the line)
- night turns: no (1 = hold everything, 0 = keep marching)
