"""grad_bar.py - Siege of Jerusalem champion graduation bar (westwall pattern).
...
Run:  python games/siege-of-jerusalem-ah/grad_bar.py --portfolio runs/<run>/portfolio.json [--procs 8]
"""
import argparse
import json
...
def main():
    ...
    for i, sd in enumerate(range(980, 985)):
        rnd = strategy_soj.random_theta(rng)
