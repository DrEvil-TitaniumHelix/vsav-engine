...
scenario = {
    ...
    "rules_scope": {
        "enforced": [
            "player-turn alternation, Axis first (3.1-3.5)",
            ...
            "ZOC: stop on entry, no pass-through, same-unit first-step ban, supply exclusion (7.1, 8.1, 8.3, 13.2)",
        ...
        "not_enforced": [
            "combat and everything downstream (3.2/3.4, 7-16) — Tier 2",
            "reinforcement/supply arrivals from the Time Record track (3.1/3.3, 12, 19) — reserve pieces are gate-rejected",
            "Rommel two-hex companion bonus (22.1) — interpretation needs validation material",
            "sea movement Tobruch/home-base (23.3-23.44)",
            "replacements (20) and substitute units (21)",
            "victory adjudication (4.1-4.3) — needs combat; game ends unadjudicated after turn 38",
        ],
    },
    "game": {
        "turns": 38,
