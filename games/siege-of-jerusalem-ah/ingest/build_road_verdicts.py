...
OPEN_OBSERVATIONS = [
    ...
    'Damascus Gate in-city approach: the U36|V36 road ends at V36; W35 entrance carries '
    'rut marks only (8.91 allows "rut marks OR connecting roads"). No road side encoded '
    'into the gate - entrance hexsides govern gate movement.',
